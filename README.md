...
<img src="docs/use-case-result.png" width="100%">

<sub>立绘 · 三视图 · 表情表 · 动作表 · 色卡 —— 一张照片进，五张资产出。</sub>
...
| 从照片来 | 世界观加的 |
|---|---|
| 厚重不齐刘海（放大成盖住上半脸的深色块） | 深青翻领 —— 走「深色大衣 + 高饱和内衬」母题 |
| 窄单眼皮 · 细直眉 | 胸前试剂瓶排、颈上放大目镜 |
| 清瘦窄肩 | 衣背 `A-1` 编号 |
| 藏青双排扣长大衣 + 肩部披肩片 | 锯齿下摆、锈汛世界的磨损语言 |
| 白立领 · 宽腿裤 | 巨大方靴 |
